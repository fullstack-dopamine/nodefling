 ...
 */
export function isStatusCodeCategory(
  statusCode: number,
  category: keyof typeof StatusCodeCategories
): boolean {
  return (StatusCodeCategories[category] as readonly number[]).includes(
    statusCode
  );
}
 ...
 */
export function getStatusCodeCategory(
  statusCode: number
): keyof typeof StatusCodeCategories | null {
